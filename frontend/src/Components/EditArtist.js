...
function EditArtist(props) {
    ...
    const [formed, setFormed] = useState(props.formed);
        ...
        <>
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={(e) => {
                        e.preventDefault();
                        console.log("hello from editArtist");
                        console.log(props.id, name, country, formed);
                        props.updateEmployee(props.id, name, country, formed);
                    }}
                          id="editmodal"
